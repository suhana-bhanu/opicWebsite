...
function Footer() {
  return (
    <>
      <div className="h-full w-full flex px-15 py-10">
        <div className="w-[40%]">
          <h1 className="font-[FoundersGrotesk-Semibold.ttf] font-semibold text-zinc-900 text-6xl leading-none tracking-tight">
            EYE-
          </h1>
          <h1 className="font-[FoundersGrotesk-Semibold.ttf] font-semibold text-zinc-900 text-6xl leading-none tracking-tight">
            OPENING
        ...
        <div className="w-[60%] flex flex-col">
          ...
          <div className="w-full mt-8">
            <p className="font-[NeueMontreal-Regular.ttf] text-lighter text-zinc-900 mb-5">
              S:
            </p>
            <p className="font-[NeueMontreal-Regular.ttf] text-lighter text-zinc-900">
              INSTAGRAM
            </p>
            <p className="font-[NeueMontreal-Regular.ttf] text-lighter text-zinc-900">
              LINKEDIN
          ...
          <div className="w-full flex">
            <div className="w-1/2">
              <p className="font-[NeueMontreal-Regular.ttf] text-lighter text-zinc-900 mb-3">
                L:
              </p>
              <p className="underline font-[NeueMontreal-Regular.ttf] text-lighter text-zinc-900">
                202-1965 W 4th Ave
              </p>
              <p className="underline font-[NeueMontreal-Regular.ttf] text-lighter text-zinc-900 mb-4">
                Vancouver, Canada
              </p>
              <p className="font-[NeueMontreal-Regular.ttf] text-lighter text-zinc-900">
                30 Chukarina St
              </p>
              <p className="font-[NeueMontreal-Regular.ttf] text-lighter text-zinc-900 mb-4">
                Lviv, Ukraine
              </p>
              <p className="mb-4 font-[NeueMontreal-Regular.ttf] text-lighter text-zinc-900">
                E:
              </p>
              <p className="font-[NeueMontreal-Regular.ttf] text-lighter text-zinc-900">
                hello@ochi.design
      ...
      <div className="w-full flex justify-between px-15 py-10">
        <svg
          width="72"
          height="30"
          viewBox="0 0 72 30"
        ...
        <p className="font-[NeueMontreal-Regular.ttf] text-lighter text-zinc-500">
